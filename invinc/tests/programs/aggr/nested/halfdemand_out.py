...
def _maint_Comp1_S_add(_e):
    # Iterate {(v5_x, v5__av1) : v5_x in deltamatch(S, 'b', _e, 1), v5__av1 in {Aggr1.smlookup('u', (), None)}, (v5_x > v5__av1[0])}
    v5_x = _e
...
def _maint_Comp1_Aggr1_add(_e):
    # Iterate {(v7_x, v7__av1) : v7_x in S, v7__av1 in deltamatch(Aggr1, 'b', _e, 1), (v7_x > v7__av1[0])}
    v7__av1 = _e
    for v7_x in S:
        if (v7_x > v7__av1[0]):
...
def _maint_Comp1_Aggr1_remove(_e):
    # Iterate {(v8_x, v8__av1) : v8_x in S, v8__av1 in deltamatch(Aggr1, 'b', _e, 1), (v8_x > v8__av1[0])}
    v8__av1 = _e
    for v8_x in S:
        if (v8_x > v8__av1[0]):
...
def _maint_Aggr1_remove(_e):
    ...
    if ((v2_val[1] == 1) and (() not in _U_Aggr1)):
...
S = Set()
print((query_Aggr1() and _m_Aggr1_u.singlelookup(()))[0])
for e in [1, 2]:
