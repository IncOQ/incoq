...
def _maint_Comp6__M_add(_e):
    ...
    for v5_s in setmatch(({_e} if ((_m__M_bw[_e[0]] if (_e[0] in _m__M_bw) else RCSet()).getref(()) == 1) else {}), 'uw', ()):
        # Begin maint _m_Comp6_out after "Comp6.add((v5_s, v5_Foo))"
        _maint__m_Comp6_out_add((v5_s, v5_Foo))
        # End maint _m_Comp6_out after "Comp6.add((v5_s, v5_Foo))"
