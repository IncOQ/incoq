...
from oinc.compiler.comp import Join, CompSpec, ClauseFactory
from oinc.compiler.obj import ObjClauseFactory_Mixin
from oinc.compiler.demand import DemClauseFactory_Mixin
...
class Manager:
    ...
    def __init__(self, namegen=None):
        ...
        from oinc.compiler.aggr import AGGR_PREFIX
    ...
    def add_invariant(self, name, inv):
        from oinc.compiler.comp import IncComp
        from oinc.compiler.aggr import IncAggr
