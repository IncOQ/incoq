...
def _maint_Comp1_dE2_Comp1_Ty1_remove(_e):
    # Iterate {(v6_y, v6_z) : v6_y in deltamatch(Comp1_Ty1, 'b', _e, 0), (v6_y, v6_z) in E}
    v6_y = _e
...
def _maint_Comp1_dE2_E_add(_e):
    # Iterate {(v7_y, v7_z) : v7_y in Comp1_Ty1, (v7_y, v7_z) in deltamatch(E, 'bb', _e, 0)}
    (v7_y, v7_z) = _e
...
def _maint_Comp1_Ty1_E_add(_e):
    # Iterate {(v3_x, v3_y) : (v3_x, v3_y) in deltamatch(E, 'bb', _e, 0)}
    (v3_x, v3_y) = _e
    if (v3_y not in Comp1_Ty1):
        # Begin maint Comp1_dE2 before "Comp1_Ty1.add(v3_y)"
        _maint_Comp1_dE2_Comp1_Ty1_add(v3_y)
        # End maint Comp1_dE2 before "Comp1_Ty1.add(v3_y)"
        Comp1_Ty1.add(v3_y)
    else:
...
def _maint_Comp1_E_add(_e):
    # Iterate {(v1_x, v1_y, v1_z) : (v1_x, v1_y) in deltamatch(E, 'bb', _e, 0), (v1_y, v1_z) in ((Comp1_dE2 - {_e}) + {_e})}
    (v1_x, v1_y) = _e
    ...
    for v1_z in setmatch({_e}, 'bu', v1_y):
        if ((v1_x, v1_z) not in Comp1):
            Comp1.add((v1_x, v1_z))
            # Begin maint _m_Comp1_out after "Comp1.add((v1_x, v1_z))"
            _maint__m_Comp1_out_add((v1_x, v1_z))
            ...
            Comp1.incref((v1_x, v1_z))
    # Iterate {(v1_x, v1_y, v1_z) : (v1_x, v1_y) in E, (v1_y, v1_z) in deltamatch(Comp1_dE2, 'bb', _e, 0), (v1_y, v1_z) in Comp1_dE2}
    (v1_y, v1_z) = _e
...
for (a, b) in {(1, 2), (2, 3), (2, 4)}:
    # Begin maint Comp1_Ty1 before "E.add((a, b))"
    _maint_Comp1_Ty1_E_add((a, b))
    # End maint Comp1_Ty1 before "E.add((a, b))"
    # Begin maint Comp1_dE2 before "E.add((a, b))"
    _maint_Comp1_dE2_E_add((a, b))
    # End maint Comp1_dE2 before "E.add((a, b))"
    # Begin maint Comp1 before "E.add((a, b))"
    _maint_Comp1_E_add((a, b))
    # End maint Comp1 before "E.add((a, b))"
