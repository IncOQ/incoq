# Manually modified version of twitter_dem_inline_notypecheck.py.
# Areas with deleted code are marked by ### comments. Cost bounds
# were not updated.
#
...
# follower sets and groups are never aliased. This is for both
# query maintenance code and for demand propagation code.
...
def follow(u, c):
    ...
    ### Eliminated second maintenance join.
