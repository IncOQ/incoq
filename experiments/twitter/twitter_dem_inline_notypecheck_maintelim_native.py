# Manually produced version of twitter_dem_inline_notypecheck_maintelim.py
# where the five filters are turned into native sets.
#
# It was easier to generate this manually by changing five lines than
# to generate it automatically and manually reapply the maintelim changes.
